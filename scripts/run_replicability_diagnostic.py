...
SP500 = GEN / "01_sp500_downstream_replication"
OUT = SP500 / "08_replicability_diagnostic"
...
def main() -> None:
    ...
    resource_tatr = read_csv(SP500 / "01_sp500_paper_protocol_resource_aware" / "tatr_prices_summary_authors_style.csv")
    resource_tmtr = read_csv(SP500 / "01_sp500_paper_protocol_resource_aware" / "tmtr_prices_summary_authors_style.csv")
    single = read_csv(SP500 / "02_sp500_tatr_single_diagnostic" / "tatr_prices_single_summary_with_change.csv")
    author_1d = read_csv(SP500 / "03_sp500_tatr_author_style_1day" / "tatr_prices_author_style_summary_with_change.csv")
    author_5d = read_csv(SP500 / "04_sp500_tatr_author_style_5day" / "tatr_prices_author_style_summary_with_change.csv")
    prices_tatr = read_csv(
        SP500 / "05_sp500_prices_and_returns_sweeps" / "downstream_prices_sp500" / "tatr_prices_summary_authors_style.csv"
    )
    prices_tmtr = read_csv(
        SP500 / "05_sp500_prices_and_returns_sweeps" / "downstream_prices_sp500" / "tmtr_prices_summary_authors_style.csv"
    )
    audit = read_csv(SP500 / "06_tatr_audit" / "tatr_results_audit_summary.csv")
    synth = read_csv(SP500 / "06_tatr_audit" / "sp500_synthetic_protocol_stats_by_run.csv")
